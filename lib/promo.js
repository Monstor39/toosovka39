...
import { promoCodes, ticketById } from "../config.js";
...
// Билеты с noPromo: true (входной за 200 ₽) скидок не принимают никогда.
function appliesTo(promo, ticketId) {
  if (ticketById[ticketId]?.noPromo) return false;
